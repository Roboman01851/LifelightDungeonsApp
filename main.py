...
class AndroidKivyApp(App):
    def build(self):
        ...
        # Character Button
        button_chara = Button(background_normal='appassets/button_imgs/button_characters.png',size_hint=(0.5, None),height=Window.width * 0.5 * (328 / 1017), pos_hint={'center_x': 0.5}) # 50% height and 50% width with respect to image resolution
